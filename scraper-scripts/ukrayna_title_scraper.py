...
# --- CONFIG ---
TITLES_FILE = "ukrayna-titles.txt"   # one title per line
OUTPUT_DIR = "ukrayna_titles_data"
FAILED_FILE = os.path.join(OUTPUT_DIR, "failed_titles.txt")

# tune these:
MAX_WORKERS = 5      # number of concurrent scrapes
SCRAPER_TIMEOUT = 120
SLEEP_BETWEEN_BATCHES = 1  # seconds between finished tasks
...
def main():
    ...
    print("\n✅ All done!")
    print(f"❗ Failed titles logged in: {FAILED_FILE}")
