...
# --- CONFIG ---
KEYWORDS = ["sığınmacı", "mülteci", "göçmen"]
OUTPUT_DIR = "gocmen_data"
os.makedirs(OUTPUT_DIR, exist_ok=True)

BASE_URL = "https://eksisozluk.com/basliklar/ara?SearchForm.Keywords={}&a=search"
HEADERS = {"User-Agent": "Mozilla/5.0"}

# match any morphological variant containing one of the stems
RE_KEYWORD = re.compile(r"(sığınmacı|mülteci|göçmen)", re.IGNORECASE)
