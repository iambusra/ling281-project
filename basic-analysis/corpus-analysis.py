...
frames = {
    "crime": [
        r"suç", r"tecavüz", r"saldır", r"öldür", r"hırsız", r"güvenlik", r"yağma"
    ],
    "economy": [
        r"ekonomi", r"işsizlik", r"yardım", r"para", r"vergi", r"maliyet", r"enflasyon"
    ],
    "solidarity": [
    ...
    "politics": [
        r"hükümet", r"iktidar", r"muhalefet", r"erdoğan", r"seçim", r"chp", r"akp", r"devlet"
    ],
    "gender": [
